...
if node[:platform] == "pop"
  include_recipe "./recipes/add_apt_repository.rb"
  include_recipe "./recipes/packages.rb"
  include_recipe "./recipes/symlink.rb"
  include_recipe "./recipes/flatpak.rb"
  include_recipe "./recipes/key_setting.rb"
  include_recipe "./recipes/scripts.rb"
end
