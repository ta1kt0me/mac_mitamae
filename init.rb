...
include_recipe "./recipes/add_apt_repository.rb" if node[:platform] == "ubuntu"
...
include_recipe "./recipes/docker.rb" if node[:platform] == "ubuntu"
...
include_recipe "./recipes/flatpak.rb" if node[:platform] == "ubuntu"
...
include_recipe "./recipes/key_setting.rb" if node[:platform] == "ubuntu"
include_recipe "./recipes/usr_local_link.rb" if node[:platform] == "ubuntu"
